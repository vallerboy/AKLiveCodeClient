...
public class Editor {
    ...
    public static VirtualizedScrollPane buildArea(CodeArea codeArea) {
        ...
        virtualizedScrollPane.getStylesheets().add(Editor.class.getClassLoader().getResource("java-keywords.css").toExternalForm());
